...
public class FlexxController extends RecyclerViewController<Void> implements View.OnClickListener {
  ...
  @Override public void onClick(View v) {
	...
	if (viewId == R.id.btn_flexxUpdates) {
	  ...
	  tdlib.ui().openUrl(this, Lang.getStringSecure(R.string.ChannelLink), new TdlibUi.UrlOpenParameters().forceInstantView());
	  ...
	  tdlib.ui().openUrl(this, Lang.getStringSecure(R.string.CrowdinLink), new TdlibUi.UrlOpenParameters().forceInstantView());
  ...
  @Override protected void onCreateView(Context context, CustomRecyclerView recyclerView) {
    ...
    items.add(new ListItem(ListItem.TYPE_SHADOW_TOP));
    items.add(new ListItem(ListItem.TYPE_SETTING, R.id.btn_tgch, R.drawable.baseline_help_24, R.string.TgChannel));
    items.add(new ListItem(ListItem.TYPE_SEPARATOR));
    items.add(new ListItem(ListItem.TYPE_SETTING, R.id.btn_crowdin, R.drawable.baseline_translate_24, R.string.Translate));
    items.add(new ListItem(ListItem.TYPE_SEPARATOR));
    items.add(new ListItem(ListItem.TYPE_SETTING, R.id.btn_sources, R.drawable.baseline_github_24, R.string.Sources));
    items.add(new ListItem(ListItem.TYPE_SEPARATOR));
    items.add(new ListItem(ListItem.TYPE_SETTING, R.id.btn_donate, R.drawable.baseline_paid_24, R.string.Donate));
    items.add(new ListItem(ListItem.TYPE_SHADOW_BOTTOM));
